            ...
            <Container>
                <Row id='r1'>
                    ...
                    <Col md={6} className="text-center" id="c1">
                        <h1 id="logo">MoMilk</h1>
                        <p>MoMilk is a cutting-edge dairy inventory management system designed to streamline and optimize the operations of dairy farmers and other stakeholders. Our software provides a centralized and automated way to track inventory, including the type of product, quantity, and expiration dates, and provides real-time data and reporting tools to help users make informed business decisions.</p>
